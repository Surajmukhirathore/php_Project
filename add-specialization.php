...
<div class="col-sm-12">
 ...
 <?php
        ...
        if (isset($_POST['submit'])) {
          ...
          $sql = mysqli_query($conn, "INSERT INTO `specialization`(`name`, `description`)
 VALUES ('$name','$description')");


          if ($sql) {
            echo "<script>alert('Role added successfully');location.href='view-specialization.php';</script>";
          } else {
