...
$id = $_GET['id'];
$sql = mysqli_query($conn, "SELECT * FROM `staff_member` where `id`='$id'");
        ...
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control" id="floatingPassword"
                            placeholder="DOB" name="date" value="<?php echo $row['date']; ?>">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="a_role" value="<?php echo $row['a_role']; ?>">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = mysqli_query($conn, "UPDATE `staff_member` SET
         `photo`='$photo',
         `f_name`='$f_name',
         `l_name`='$l_name',
         `gender`='$gender',
