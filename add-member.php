        ...
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="weight">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="height">
                        <label for="floatingPassword">Height</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="chest">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="waist">
                        <label for="floatingPassword">Waist</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="thigh">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="arms">
                        <label for="floatingPassword">Arms</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPassword"
                            placeholder="Password" name="fat">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $date1 = $_POST['date1'];
                    $date2 = $_POST['date2'];
                    $sql = mysqli_query($conn, "INSERT INTO `member`(`photo`, `f_name`, `l_name`, `gender`, `date`, `m_group`, `address`, `city`, `state`, `phone`, `email` , `weight`, `height`, `chest`, `waist`, `thigh` , `arms`, `fat`, `s_member`, `m_ship` , `date1`, `date2`)
 VALUES ('$photo','$f_name','$l_name','$gender','$date','$m_group','$address','$city','$state','$phone','$email','$weight','$height','$chest','$waist','$thigh','$arms','$fat' ,'$s_member','$m_ship','$date1', '$date2')");
